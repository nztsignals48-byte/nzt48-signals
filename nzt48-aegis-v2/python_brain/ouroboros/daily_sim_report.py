...
<p class="sub">VanguardSniper | Crucible Mode (Paper) | {regime} Regime</p>
...
<p class="fs">AEGIS V2 | VanguardSniper | Crucible Mode | {date_str} | {len(entries)} entries, {len(exits)} exits | £{total_pnl:,.2f} P&amp;L</p>
